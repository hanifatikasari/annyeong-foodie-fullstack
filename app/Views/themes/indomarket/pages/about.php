    ...
    <div class="container">
        <div class="row align-items-center mb-5">
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p>Annyeong Foodie adalah usaha kuliner Korean food yang berbasis di Kabupaten Batang, Kecamatan Bawang, Jawa Tengah. Kami mengkhususkan diri pada produk-produk makanan Korea seperti Kimbab, Dimsum, Tteokbokki, dan berbagai pilihan lainnya.</p>
        ...
        <div class="row text-center mb-5">
            ...
            <div class="col-md-4 mb-3">
                ...
                <h6>Alamat</h6>
                <p class="text-muted">TRIUMPHANT FUTSAL, Bantir, Bawang, Kec. Bawang, Kabupaten Batang, Jawa Tengah 51274</p>
            </div>
            <div class="col-md-4 mb-3">
                <i class="fa fa-whatsapp fa-2x text-success mb-2"></i>
                <h6>WhatsApp</h6>
                <p class="text-muted"><a href="https://wa.me/6281234567890">+62 858-7950-5277</a></p>
            </div>
            <div class="col-md-4 mb-3">
                <i class="fa fa-instagram fa-2x text-danger mb-2"></i>
                <h6>Instagram</h6>
                <p class="text-muted"><a href="#">@annyeong.foodie</a></p>
            </div>
        </div>
    </div>
</section>
