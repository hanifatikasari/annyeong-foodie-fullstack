        ...
        <div class="row justify-content-center">
            <div class="col-md-8 text-center">
                <div class="card shadow-sm p-5">
                    ...
                    <h4 class="text-primary font-weight-bold mb-3"><?= esc($order['invoice_no']) ?></h4>

                    <div class="alert alert-warning text-left">
                        <h6><i class="fa fa-info-circle mr-1"></i>Langkah Selanjutnya:</h6>
                        <ol class="mb-0 pl-4">
                            <li>Lakukan pembayaran sebesar <strong>Rp <?= number_format($order['total_bayar']) ?></strong></li>
                    ...
                    <div class="d-flex justify-content-center gap-3 flex-wrap mt-3">
                        <a href="<?= site_url('checkout/upload/' . $order['invoice_no']) ?>" class="btn btn-primary btn-lg mr-2">
                            <i class="fa fa-upload mr-1"></i> Upload Bukti Bayar
                        </a>
                        <a href="<?= site_url('account/orders') ?>" class="btn btn-outline-secondary btn-lg">
