                    ...
                    <div class="col-md-3">
                        <nav class="nav-category">
                            ...
                            <ul class="menu-category">
                                ...
                                <li><a href="#">Desserts & Snacks</a></li>
                                <li><a href="#">Korean Meals</a></li>
                                <li><a href="#">Beverages</a></li>
                                <li><a href="#">Birthday Package</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div class="col-md-9">
                            ...
                            <div class="carousel-inner shadow-sm rounded">
                                <div class="carousel-item active">
                                    ...
                                    <div class="carousel-caption d-none d-md-block">
                                        <h5 style="color: #dde2ec; font-weight: 400; text-shadow: 2px 2px 4px rgba(0,0,0,0.6); font-family: 'Poppins', sans-serif;">
                                            The Best Seller Kimbab
                                        </h5>
                                    </div>
                                </div>
            ...
            <div class="row mt-4">
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Dimsum Mentai X Tartar</a></h3>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Dimsum Kuah</a></h3>
                            <div class="product-price">
                                <span>Rp 27.000</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Kimbab Chicken Katsu</a></h3>
                            <div class="product-price">
                                <span>Rp 22.000</span>
                            </div>
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-4 col-12">
                    <div class="single-product">
                        ...
                        <div class="product-content">
                            <h3><a href="product-detail.html">Mochi Dessert</a></h3>
                            <div class="product-price">
                                <span>Rp 6.000</span>
                            </div>
                        </div>
