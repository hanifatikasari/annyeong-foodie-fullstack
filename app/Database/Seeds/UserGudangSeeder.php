    ...
    public function run()
    {
       // 1. Definisikan password. 
        ...
        $userData = [
            ...
            'username'   => 'gudang',
            'password'   => $password,
            'email'      => 'gudang@annyeongfoodie.com',
        ...
        // 3. Hubungkan ke group 'gudang'
        // Kita cari dulu ID group yang namanya 'gudang' dari tabel groups
        $group = $this->db->table('groups')->where('name', 'gudang')->get()->getRow();
